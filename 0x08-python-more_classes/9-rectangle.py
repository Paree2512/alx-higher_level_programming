...
"""
Rectangle class that defines a rectangle from Module 8-rectangle.
"""
...
class Rectangle:
    ...
    def area(self):
        """
        Calculate rea of rectangle based on valid widths and heights.
        """
    ...
    def square(cls, size=0):
        """
        Method that allows us to create a new instance representing
        a square with the same width and height
        """
